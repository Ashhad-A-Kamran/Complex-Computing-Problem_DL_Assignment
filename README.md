...
1. notebook.ipynb the orignial Jupyter Notebook (github renderer is fragile and explodes upon preview, so plesae open the *notebook.pdf*)
2. notebook.pdf
3. *report.html* or *Report.pdf* (both are generated by the same script)
